...
include('../../controls/supplier/updatecheck.php');
...
$userQuery=$connection->CheckUser($conobj,"supplier",$_SESSION["username"],$_SESSION["password"]);
...
<a href="../../controls/supplier/logout.php"> logout</a>
</div>
</body>
</html>